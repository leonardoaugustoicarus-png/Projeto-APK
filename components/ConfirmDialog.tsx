    ...
    switch (variant) {
      case 'danger':
        return {
          ...
          button: 'bg-red-600 hover:bg-red-500 border-red-800',
          border: 'border-red-600'
        };
      case 'warning':
        return {
          icon: <ShoppingCart size={32} className="text-yellow-500" />,
          button: 'bg-green-600 hover:bg-green-500 border-green-800',
          border: 'border-green-600'
        };
      default:
        return {
          icon: <HelpCircle size={32} className="text-orange-500" />,
          button: 'bg-orange-600 hover:bg-orange-500 border-orange-800',
      ...
      >
        <div className="p-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <button
              onClick={onClose}
              className="flex-1 px-6 py-3 bg-red-950 text-white font-black uppercase tracking-widest text-[10px] rounded-xl border-b-4 border-black/40 hover:bg-red-900 transition-all active:translate-y-1 active:border-b-0"
            >
              Cancelar
            </button>
            <button
              ...
              className={`flex-1 px-6 py-3 ${styles.button} text-white font-black uppercase tracking-widest text-[10px] rounded-xl border-b-4 shadow-xl transition-all active:translate-y-1 active:border-b-0`}
            >
              {confirmLabel}
            </button>
          </div>
