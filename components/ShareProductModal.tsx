    ...
    <div className="fixed inset-0 z-[130] flex items-center justify-center p-4 bg-black/90 backdrop-blur-sm animate-in fade-in duration-300">
      <div className="bg-red-900 border-4 border-orange-500 rounded-2xl shadow-[0_0_50px_rgba(0,0,0,0.8)] w-full max-w-sm overflow-hidden animate-in zoom-in-95 duration-200">
        ...
        <div className="p-6 space-y-4">
          ...
          <button
            onClick={handleCopy}
            className={`w-full py-3 rounded-xl font-black uppercase text-[10px] tracking-widest transition-all flex items-center justify-center gap-2 border-b-4 shadow-xl active:translate-y-1 active:border-b-0 ${
              copied 
                ? 'bg-green-600 border-green-800 text-white' 
                : 'bg-yellow-500 border-orange-700 text-red-950 hover:bg-yellow-400'
            }`}
          >
            {copied ? (
              <>
